...
<div class="row">
  <div class="d-flex justify-content-end align-items-center flex-wrap grid-margin">
    <form 
      action="{{ route('transaction.pengeluaran.cari') }}" 
            method="POST" 
    ...
    <div class="d-flex align-items-center flex-wrap text-nowrap">
      ...
      <div class="input-group flatpickr wd-200 me-2 mb-2 mb-md-0" id="dashboardDate">
        <select class="form-select" id="" name="cabang">
          <option value="all">ALL Cabang</option>
          @foreach (cabang::all() as $item)
    ...
    <form action="{{ route('transaction.pengeluaran.pdf') }}" 
    method="POST" 
    enctype="multipart/form-data"  >
      @csrf
      <input type="hidden" value="{{$hidde['cabang']}}" name="cabang" >
